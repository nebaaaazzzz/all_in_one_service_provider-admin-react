          ...
          <div className="container-xl">
              ...
              <div className="app-card-body p-4 pt-0">
                ...
                >
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="faq1-heading-1">
                      <button
                  ...
                  {/*//accordion-item*/}
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="faq1-heading-2">
                      <button
                        className="accordion-button btn btn-link"
                        type="button"
                        data-bs-toggle="collapse"
                  ...
                  {/*//accordion-item*/}
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="faq1-heading-3">
                      <button
                        className="accordion-button btn btn-link"
                        type="button"
                        data-bs-toggle="collapse"
                  ...
                  {/*//accordion-item*/}
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="faq1-heading-4">
                      <button
                        className="accordion-button btn btn-link"
                        type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#faq1-4"
                        aria-expanded="false"
                  ...
                  {/*//accordion-item*/}
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="faq1-heading-5">
                      <button
                        className="accordion-button btn btn-link"
                        type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#faq1-5"
                        aria-expanded="false"
                  ...
                  {/*//accordion-item*/}
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="faq1-heading-6">
                      <button
                        className="accordion-button btn btn-link"
                        type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#faq1-6"
                        aria-expanded="false"
            ...
            <div className="app-card app-card-accordion shadow-sm mb-4">
              <div className="app-card-header p-3">
                <h4 className="app-card-title">Account</h4>
              </div>
              {/*//app-card-header*/}
              <div className="app-card-body p-4 pt-0">
                <div
                  id="faq2-accordion"
                  className="faq2-accordion faq-accordion accordion"
                >
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="faq2-heading-1">
                      <button
                        className="accordion-button btn btn-link"
                        type="button"
                        data-bs-toggle="collapse"
                  ...
                  {/*//accordion-item*/}
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="faq2-heading-2">
                      <button
                        className="accordion-button btn btn-link"
                        type="button"
                        data-bs-toggle="collapse"
                  ...
                  {/*//accordion-item*/}
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="faq2-heading-3">
                      <button
                        className="accordion-button btn btn-link"
                        type="button"
                        data-bs-toggle="collapse"
                  ...
                  {/*//accordion-item*/}
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="faq2-heading-4">
                      <button
                        className="accordion-button btn btn-link"
                        type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#faq2-4"
                        aria-expanded="false"
                  ...
                  {/*//accordion-item*/}
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="faq2-heading-5">
                      <button
                        className="accordion-button btn btn-link"
                        type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#faq2-5"
                        aria-expanded="false"
                        aria-controls="faq5"
                      >
                        Can I viverra sit amet quam eget lacinia?
            ...
            <div className="app-card app-card-accordion shadow-sm mb-4">
              <div className="app-card-header p-3">
                <h4 className="app-card-title">Payment</h4>
              </div>
              {/*//app-card-header*/}
              <div className="app-card-body p-4 pt-0">
                <div
                  id="faq3-accordion"
                  className="faq3-accordion faq-accordion accordion"
                >
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="faq3-heading-1">
                      <button
                        className="accordion-button btn btn-link"
                        type="button"
                        data-bs-toggle="collapse"
                  ...
                  {/*//accordion-item*/}
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="faq3-heading-2">
                      <button
                        className="accordion-button btn btn-link"
                        type="button"
                        data-bs-toggle="collapse"
                ...
                <div className="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
                  <div className="app-card-header p-3 border-bottom-0">
                    <div className="row align-items-center gx-3">
                      ...
                      {/*//col*/}
                      <div className="col-auto">
                        <h4 className="app-card-title">Want to upgrade?</h4>
                      </div>
                      {/*//col*/}
                    </div>
                    {/*//row*/}
                  ...
                  <div className="app-card-body px-4">
                    <div className="intro mb-3">
                      ...
                      ligula neque. Praesent id ligula ut sem suscipit eleifend
                      id vel ex.
                    </div>
                    <ul className="list-unstyled">
                      <li>
                        <svg
                          ...
                          height="1em"
                          viewBox="0 0 16 16"
                          className="bi bi-check2 text-primary me-2"
                          fill="currentColor"
                          xmlns="http://www.w3.org/2000/svg"
                        >
                          <path
