            ...
            <nav id="app-nav-main" className="app-nav app-nav-main flex-grow-1">
              ...
              >
                ...
                <li className="nav-item has-submenu">
                  {/*//Bootstrap Icons: https://icons.getbootstrap.com/ */}
                  <a
                    className="nav-link submenu-toggle active"
                    href="#"
                  ...
                  <div
                    id="submenu-1"
                    className="collapse submenu submenu-1 show"
        ...
        <div className="app-content pt-3 p-md-3 p-lg-4">
          <div className="container-xl">
            ...
            <div className="app-card app-card-notification shadow-sm mb-4">
              <div className="app-card-header px-4 py-3">
                <div className="row g-3 align-items-center">
                  ...
                  <div className="col-12 col-lg-auto text-center text-lg-start">
                    <div className="notification-type mb-2">
                      <span className="badge bg-warning">Billing</span>
                    </div>
                    <h4 className="notification-title mb-1">
                      Notification Heading Lorem Ipsum
                    </h4>
              ...
              <div className="app-card-body p-4">
                <div className="notification-content">
                  Praesent nibh massa, posuere non mollis vel, molestie non
                  mauris. Aenean consequat facilisis orci, sed sagittis mauris
                  interdum at.
                </div>
              </div>
              {/*//app-card-body*/}
            ...
            <div className="app-card app-card-notification shadow-sm mb-4">
              ...
              <div className="app-card-body p-4">
                <div className="notification-content">
                  Proin a magna sit amet mauris mollis mattis in at dui. Fusce
                  laoreet metus et nunc lobortis, suscipit sollicitudin augue
                  pellentesque. Maecenas maximus iaculis scelerisque.
                </div>
              </div>
              {/*//app-card-body*/}
              <div className="app-card-footer px-4 py-3">
            ...
            <div className="app-card app-card-notification shadow-sm mb-4">
              ...
              <div className="app-card-body p-4">
                <div className="notification-content">
                  ...
                  Pellentesque auctor ut elit vel feugiat. Sed a mauris tempor,
                  tempor lacus vel, tristique metus. Nulla interdum felis id
                  metus fermentum laoreet.
                </div>
              </div>
              {/*//app-card-body*/}
              <div className="app-card-footer px-4 py-3">
